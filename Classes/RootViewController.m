...
- (IBAction)about:(id)sender {
	...
	UIAlertView *alert = [[UIAlertView alloc]
						  ...
						  message:@"Diese App ist ein Community-Projekt und steht unter der Lizenz GPL v2. Entwickelt wurde sie mit freundlicher Unterstützung der Apfeltalk GmbH, Breitmoss 46, 83334 Inzell. \n\nFür die Richtigkeit der Inhalte wird nicht gehaftet. \n\nDie Forenzugriffs-API stammt von Tapatalk."
						  delegate:self
